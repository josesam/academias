...
class SugarWidgetSubPanelEditButtonCustom extends SugarWidgetField
{
...
//		$onclick .= "document.forms['{$formname}'].record.value='';retValz;return false;";
                ...
                $onclick = "<a href=\"index.php?module={$layout_def['module']}&action=DetailView&record={$layout_def['fields']['ID']}\">";
		$onclick.= self::$edit_icon_html . '&nbsp;' . $app_strings['LNK_EDIT'] .'</a>&nbsp;';
