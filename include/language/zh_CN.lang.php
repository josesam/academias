...
$app_strings = array (
  ...
  'LBL_INBOUNDEMAIL_ID' => '内部邮件编号',
  'LBL_SUGAR_COPYRIGHT_SUB' => '© 2004-2011 <a href="www.sugarcrm.com" target="_blank" >SugarCRM Inc.</a>. 保留所有权利。
SugarCRM是完全属于SugarCRM, Inc.的商标。任何其他公司和产品名可能是其他相关公司或关联组织的商标。
',
  'WARN_UNSAVED_CHANGES' => '你将离开此记录且不保存任何的你已经完成的修改。你是否确认要离开此记录？',
  ...
  'LBL_PLUGINS_TITLE' => 'Sugar Plug-ins for Microsoft Office TM',
...
这不能被重做.',
  ...
  'LBL_EMAIL_ACCOUNTS_OUTBOUND' => '发件箱属性',
  ...
  'LBL_EMAIL_WARNING_MISSING_USER_CREDS' => '警告：缺少用户名和发送邮件帐户密码。',
  'LBL_EMAIL_ACCOUNTS_SMTPUSER_REQD' => 'SMTP用户名是必需的',
  'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD' => 'SMTP密码是必需的',
  'LBL_EMAIL_ACCOUNTS_TITLE' => '邮件帐户管理',
  'LBL_EMAIL_POP3_REMOVE_MESSAGE' => 'POP3邮件服务器协议类型将不会在下一个版本中支持。只有将支持IMAP的。',
  ...
  'LBL_EMAIL_REMOVE_SMTP_WARNING' => '警告！您正在试图删除的外发邮件帐户是已经关联到一个现有监视邮箱的帐户。您确定要继续吗？',
  ...
  'LBL_EMAIL_ERROR_NO_OUTBOUND' => '没有器指定外发邮件服务器。',
  ...
  'LBL_EMAIL_TEST_OUTBOUND_SETTINGS_SENT' => '测试邮件已发出',
  ...
  'LBL_STREET' => '街道',
  'LBL_SUBJECT' => '主题',
  'LBL_SUGAR_COPYRIGHT' => '&amp;copy; 2004-2011 <a href="http://www.sugarcrm.com" target="_blank" class="copyRightLink">SugarCRM Inc.</a> 保留所有权利.',
  'LBL_SYNC' => '同步',
  'LBL_TABGROUP_ALL' => '所有',
