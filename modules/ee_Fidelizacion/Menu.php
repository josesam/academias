...
if(ACLController::checkAccess('ee_Fidelizacion', 'edit', true))$module_menu[]=Array("index.php?module=ee_Fidelizacion&action=EditView&return_module=ee_Fidelizacion&return_action=DetailView", $mod_strings['LNK_NEW_RECORD'],"Createee_Fidelizacion", 'ee_Fidelizacion');
