 ...
 * PLACE ANY CUSTOMIZATIONS IN ee_Participantes
 */

require_once('include/SugarObjects/templates/person/Person.php');

class ee_Participantes_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'ee_Participantes';
	var $object_name = 'ee_Participantes';
	var $table_name = 'ee_participantes';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
		...
		var $email_addresses;
		var $picture;
			function ee_Participantes_sugar(){	
		parent::Person();
	}
