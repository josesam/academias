 ...
 * PLACE ANY CUSTOMIZATIONS IN ee_Profesores
 */

require_once('include/SugarObjects/templates/person/Person.php');

class ee_Profesores_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'ee_Profesores';
	var $object_name = 'ee_Profesores';
	var $table_name = 'ee_profesores';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
