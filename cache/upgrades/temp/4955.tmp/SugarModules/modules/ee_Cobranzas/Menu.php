...
if(ACLController::checkAccess('ee_Cobranzas', 'edit', true))$module_menu[]=Array("index.php?module=ee_Cobranzas&action=EditView&return_module=ee_Cobranzas&return_action=DetailView", $mod_strings['LNK_NEW_RECORD'],"Createee_Cobranzas", 'ee_Cobranzas');
