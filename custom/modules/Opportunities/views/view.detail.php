...
class OpportunitiesViewDetail extends ViewDetail {
 	...
 	function display() {
		global $app_list_strings;
              ...
              if(!empty($this->bean->id)){
                if (file_exists('custom/include/clases/varios/ManejoEtapasVenta.php')){
                    ...
                    $this->bean->sales_stage=(empty($data))? $this->bean->sales_stage : $manejo->prepareEditField($this->bean->sales_stage);
        ...
        function  _displaySubPanels() {
          ...
          unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['opportunities_ee_cobranzas']['top_buttons'][0]);
          unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['opportunities_ee_cobranzas']['top_buttons'][1]);
