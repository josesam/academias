...
class ContactsViewDetail extends ViewDetail {
 	...
 	function ContactsViewDetail(){
        ...
        function  _displaySubPanels() {
           ...
           unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['cases']['top_buttons'][1]);
          ...
          unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['ee_ejecucionprograma_contacts']['top_buttons'][0]);
          unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['ee_ejecucionprograma_contacts']['top_buttons'][1]);
               
          unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['contacts']);

           unset($subpanel->subpanel_definitions->layout_defs['subpanel_setup']['contacts_ac_certificado']['top_buttons'][1]);
           $subpanel->subpanel_definitions->layout_defs['subpanel_setup']['contacts_ac_certificado']['top_buttons'][0]['widget_class']='SubPanelTopCreateButton';
