...
class NumerosTexto {
	 ...
	 * @return string
	 */
	function convertirEntero($cifra, $textoUno = 'one'){
		$t = (string)$cifra;
		$un = explode(',',",$textoUno,two,three,four,five,six,seven,eight,nine"); // ojo con el manejo del uno
		$dec = explode(',',',:esp_dec,twenty,thirty,forty,fifty,sixty,seventy,eightt,ninty');
		$cen = explode(',',',:esp_cen,two,three,four,five,six,seven,eight,nin'); //ientos

		$calificador = array('','thousand','mill','mil','bill','mil','trill','mil','cuatrill','mil','quintill', 'mil','sexti'); // ones u ón
		$esp_dec = explode(',',',eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen');
