...
buscarModulo=function (){
    var data={
            ejecucion:jQuery("#ee_ejecucionprograma_ee_encuestaitcee_ejecucionprograma_ida").val(),
            nombre:jQuery("#filtro_modulo").val()
        }

    var urllista = "index.php?&module=ee_EncuestaITC&action=modulos";
...
buscarParticipante=function (){
    ...
    var urllista = "index.php?&module=ee_EncuestaITC&action=participante";
