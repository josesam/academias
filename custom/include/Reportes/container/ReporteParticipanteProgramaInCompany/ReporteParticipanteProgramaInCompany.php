...
class ReporteParticipanteProgramaInCompany extends SP_Reporte {
    protected $parametros;
    public $fecha_inicio;
    public $fecha_final;
    public $archivo="ReporteParticipanteProgramaInCompany";
    ...
    */
    function __construct(& $form){
        global $app_list_strings;
         ...
         $this->reporte="ReporteParticipanteProgramaInCompany";
    ...
    */
    function  setSql() {
        ...
        $query="
                    SELECT a.name cliente,dc.programa,concat(c.first_name,' ',c.last_name ) nombres,c.*, c.title cargo,
   ...
   function armarFiltros(){
        $filtros=" and  pr.fechainicio_programa between '".$this->form['fecha_inicial']."' and '".$this->form['fecha_final']."'";
            ...
            $filtros.= " and pr.tipoprograma in ('Incompany')";
